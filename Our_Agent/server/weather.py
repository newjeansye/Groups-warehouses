...
# API 密钥
OPENWEATHER_API_KEY = "d7aadb72af4007994d98593361db009b"
# API 调用的身份识别
...
async def get_weather(city: str, country_code: str = None, state_code: str = None, units: str = "metric",
                      lang: str = "zh_cn") -> str:
...
@mcp.tool()
async def get_forecast(city: str, country_code: str = None, state_code: str = None, units: str = "metric",
                       lang: str = "zh_cn") -> str:
...
async def weather_prompt(city: str, weather_desc: str, temp: float, humidity: float, wind_speed: float, temp_unit: str,
                         speed_unit: str) -> str:
    """用于生成天气报告的提示模板
    ...
    """
    # 构建天气报告的格式化文本
    return f"""请你作为专业的气象播报员，根据以下天气数据生成一份简结、易懂的天气报告:
...
@mcp.tool()
async def weather_report(city: str, country_code: str = None, state_code: str = None, units: str = "metric",
                         lang: str = "zh_cn") -> dict:
    """获取指定城市的天气信息并提供报告模板
